namespace RemindersAPI.SignalR
{
    public static class MessageConstants
    {
        ...
        public static readonly string SHOPPING_LIST_ITEM_UPDATED = "ShoppingListItemUpdated";
        public static readonly string SHOPPING_LIST_ITEM_DELETED = "ShoppingListItemDeleted";
